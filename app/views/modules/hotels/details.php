    ...
    <div class="container">
        ...
        <div class="sticky">
            ...
            <ul class="tabs flex flex-content-between row-rtl">
                ...
                <li>
                    <a href="#hotel-detail">hotel details</a>
                </li>
            </ul>
        </div>
                                    ...
                                    <div class="room-wrapper-inner">
                                        <div class="row row-rtl">
                                            <div class="c2">
                                                ...
                                                <label for="1b" class="direct f-right btn m"><input type="checkbox" id="1b" class="mr-10">1 Bed</label>
                                                <label for="2b" class="direct f-right btn m"><input type="checkbox" id="2b" class="mr-10">2 Beds</label>
                                                <label for="3b" class="direct f-right btn m"><input type="checkbox" id="3b" class="mr-10">3 Beds</label>
                                            </div>
                                            <div class="c10">
                                                <?php for ($i = 1; $i <= 4; $i++) { ?>
                                                <div class="row panel">
